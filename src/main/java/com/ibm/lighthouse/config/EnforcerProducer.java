...
public class EnforcerProducer {
    ...
    public EnforcerProducer() {
        ...
        Adapter adapter = new IsAdapter("/casbin/policy.csv");

        InputStream is = EnforcerProducer.class.getResourceAsStream("/casbin/model.conf");
        ...
        this.enforcer.addFunction("abacMatcherWrapper", new AbacMatcher());
    }
